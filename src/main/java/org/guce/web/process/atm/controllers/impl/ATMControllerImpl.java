...
public abstract class ATMControllerImpl extends ATMController {
    ...
    @EJB
    protected TypeAvtechServiceImpl typeAvtechServiceImpl;
   ...
   protected void loadProductType(){
     ...
     if(avisTechCode != null){
        ...
        else if (selectedTypeAvisTechnique != null &&selectedTypeAvisTechnique.equals(ATMConstant.MATERIEL_EQUIPEMENT)){
           this.officeSelected.put("DPAAIE", "DPAAIE");
         }
      

      else if (selectedTypeAvisTechnique != null && selectedTypeAvisTechnique.equals(ATMConstant.INGREDIENT_ADDITIFS)){
        this.officeSelected.put("DPAAIE", "DPAAIE");
        }
         
    else if (selectedTypeAvisTechnique != null && current.getOfficeCode().equals("DPAAIE")){
        this.officeSelected.put("DPAAIE", "DPAAIE");
        }
