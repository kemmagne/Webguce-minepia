...
public class AvisTechRepository extends AbstractFacade<AvisTech> {
    @PersistenceContext(
            unitName = "Partner-ejb-unity"
    )
    private EntityManager em;

    public AvisTechRepository() {
    ...
    public List<AvisTech> findByDomain(String domain) {
        ...
        String qb = "Select distinct i from AvisTech i where i.deleted=false and i.active = true "+domain ;
        System.out.println(qb);
        TypedQuery<AvisTech> query = em.createQuery(qb, AvisTech.class);
        return query.getResultList();
    }

    public int searchCount(SearchFilter filter) {
        String qb = "Select count(distinct i) from AvisTech i where i.deleted=false ";
    ...
    public List<AvisTech> search(SearchFilter filter, int start, int count, String orderField, String order) {
        ...
        String qb = "Select distinct i from AvisTech i where i.deleted=false";
        qb = addConditions(qb, filter);
