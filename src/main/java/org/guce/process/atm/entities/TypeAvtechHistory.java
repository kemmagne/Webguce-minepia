...
@Entity
@Table(
        name = "ATM_TYPEAVIS_HY"
)
public class TypeAvtechHistory implements Serializable {
    @Id
    @SequenceGenerator(
            name = "ATM_TYPEAVIS_HY_SEQ",
            sequenceName = "ATM_TYPEAVIS_HY_SEQ",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "ATM_TYPEAVIS_HY_SEQ"
    )
    private String id;
    ...
    public TypeAvtech getItemId() {
        return this.itemId;
    }

    public void setItemId(TypeAvtech itemId) {
        this.itemId = itemId;
    }
