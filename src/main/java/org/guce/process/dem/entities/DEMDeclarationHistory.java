...
@Entity
@Table(
        name = "DEM_DEM_TYPE_HY"
)
public class DEMDeclarationHistory implements Serializable {
    @Id
    @SequenceGenerator(
            name = "DEM_DEM_TYPE_HY_SEQ",
            sequenceName = "DEM_DEM_TYPE_HY_SEQ",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "DEM_DEM_TYPE_HY_SEQ"
    )
    private String id;
    ...
    public DEMDeclaration getItemId() {
        return this.itemId;
    }

    public void setItemId(DEMDeclaration itemId) {
        this.itemId = itemId;
    }
