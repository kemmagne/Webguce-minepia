...
public class DEMDeclarationRepository extends AbstractFacade<DEMDeclaration> {
    @PersistenceContext(
            unitName = "Partner-ejb-unity"
    )
    private EntityManager em;

    public DEMDeclarationRepository() {
    ...
    public List<DEMDeclaration> findByDomain(String domain) {
        ...
        String qb = "Select distinct i from DEMDeclaration i where i.deleted=false and i.active = true "+domain ;
        System.out.println(qb);
        TypedQuery<DEMDeclaration> query = em.createQuery(qb, DEMDeclaration.class);
        return query.getResultList();
    }

    public int searchCount(SearchFilter filter) {
        String qb = "Select count(distinct i) from DEMDeclaration i where i.deleted=false ";
    ...
    public List<DEMDeclaration> search(SearchFilter filter, int start, int count, String orderField, String order) {
        ...
        String qb = "Select distinct i from DEMDeclaration i where i.deleted=false";
        qb = addConditions(qb, filter);
