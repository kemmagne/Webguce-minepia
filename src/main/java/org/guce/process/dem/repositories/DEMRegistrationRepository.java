...
public class DEMRegistrationRepository extends AbstractFacade<DEMRegistration> {
    @PersistenceContext(
            unitName = "Partner-ejb-unity"
    )
    private EntityManager em;

    public DEMRegistrationRepository() {
        super(DEMRegistration.class);
    }
    ...
    public List<DEMRegistration> findByDomain(String domain) {
        ...
        String qb = "Select distinct i from DEMRegistration i where i.deleted=false and i.active = true "+domain ;
        System.out.println(qb);
        TypedQuery<DEMRegistration> query = em.createQuery(qb, DEMRegistration.class);
        return query.getResultList();
    }

    public int searchCount(SearchFilter filter) {
        String qb = "Select count(distinct i) from DEMRegistration i where i.deleted=false ";
    ...
    public List<DEMRegistration> search(SearchFilter filter, int start, int count, String orderField, String order) {
        ...
        String qb = "Select distinct i from DEMRegistration i where i.deleted=false";
        qb = addConditions(qb, filter);
