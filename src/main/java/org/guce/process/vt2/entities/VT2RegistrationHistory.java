...
public class VT2RegistrationHistory implements Serializable {
    @Id
    @SequenceGenerator(
            name = "VT2_MINEPDED_REGISTRATION_SEQ",
            sequenceName = "VT2_MINEPDED_REGISTRATION_SEQ",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "VT2_MINEPDED_REGISTRATION_SEQ"
    )
    private String id;
